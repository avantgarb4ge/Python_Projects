...
class ParentWindow(Frame):
    ...
    def transferFiles(self):
        ...
        # subtract 24 hrs from current date and time
        twentyfourHours = curTime - datetime.timedelta(hours=24)
        ...
        for i in source_files:
            ...
            # if modifcationTime is more recent than 24 hrs
            if modificationTime > twentyfourHours:
    ...
    def exit_program(self):
        ...
        # python to terminate root.mainloop and all widgets inside GUI window
        root.destroy()
